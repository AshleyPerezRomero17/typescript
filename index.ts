...
class BankAccount {
  ...
  // This means that the "Shape" class cannot be instantiated on its own.
    ...
    // This means that any class that extends the "Shape" class must provide its own implementation of the "area" method.
    abstract area(): number;
    }
    
  // The "Rectangle" class extends the "Shape" class, which means it inherits the "width" and "height" properties and the abstract "area" method.
